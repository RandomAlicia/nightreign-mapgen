...
{
    /// <summary>
    /// Labels for Sorcerers_Rise points.
    /// </summary>
    public static class LabelerMinorBase
    {
        ...
        )
        {
            ...
            Console.WriteLine($"[Sorcerers_Rise Labels] total={total} drawn={drawn} missingI18n={missingI18n}");
        }
        ...
        private static Dictionary<string, (int dx, int dy)> ReadOffsets(JsonElement root)
        {
            ...
            if (root.TryGetProperty("LabelOffsets", out var lo) && lo.ValueKind == JsonValueKind.Object &&
                lo.TryGetProperty("MinorBase", out var ok) && ok.ValueKind == JsonValueKind.Object)
            {
